...
#[no_mangle]
pub extern "C" fn citadel_run_embedded(
    chain: *const c_char,
    ...
    citadel::run_embedded(config)
        .map(citadel_client_t::with)
        .unwrap_or_else(citadel_client_t::from_err)
}

#[no_mangle]
pub extern "C" fn citadel_contract_list(
...
#[no_mangle]
pub extern "C" fn citadel_single_sig_create(
    client: *mut citadel_client_t,
    name: *const c_char,
...
#[no_mangle]
pub extern "C" fn citadel_contract_operations(
    client: *mut citadel_client_t,
...
#[no_mangle]
pub extern "C" fn citadel_contract_rename(
    client: *mut citadel_client_t,
    contract_id: *const c_char,
...
#[no_mangle]
pub extern "C" fn citadel_contract_delete(
    client: *mut citadel_client_t,
    contract_id: *const c_char,
) -> *const c_char {
    let client = citadel_client_t::from_raw(client);
...
#[no_mangle]
pub extern "C" fn citadel_contract_balance(
    client: *mut citadel_client_t,
    contract_id: *const c_char,
    rescan: bool,
    lookup_depth: u8,
...
#[no_mangle]
pub extern "C" fn citadel_address_list(
    client: *mut citadel_client_t,
    contract_id: *const c_char,
    rescan: bool,
    lookup_depth: u8,
...
#[no_mangle]
pub extern "C" fn citadel_address_create(
    client: *mut citadel_client_t,
    contract_id: *const c_char,
    mark_used: bool,
    legacy: bool,
...
#[no_mangle]
pub extern "C" fn citadel_invoice_create(
    client: *mut citadel_client_t,
...
#[no_mangle]
pub extern "C" fn citadel_invoice_list(
    client: *mut citadel_client_t,
    contract_id: *const c_char,
) -> *const c_char {
    let client = citadel_client_t::from_raw(client);
...
#[no_mangle]
pub extern "C" fn citadel_address_pay(
    client: *mut citadel_client_t,
    ...
    let address = match client.parse_string(address, "address") {
        Ok(address) => address,
        Err(_) => {
            client.set_error(citadel::Error::ServerFailure(Failure {
                code: 0,
...
#[no_mangle]
pub extern "C" fn citadel_invoice_pay(
    client: *mut citadel_client_t,
    contract_id: *const c_char,
...
#[no_mangle]
pub extern "C" fn citadel_psbt_publish(
    client: *mut citadel_client_t,
    psbt: *const c_char,
) -> *const c_char {
    let client = citadel_client_t::from_raw(client);
...
#[no_mangle]
pub extern "C" fn citadel_asset_list(
    client: *mut citadel_client_t,
) -> *const c_char {
    let client = citadel_client_t::from_raw(client);
    client
...
#[no_mangle]
pub extern "C" fn citadel_asset_import(
    client: *mut citadel_client_t,
